...
class PostForm(forms.ModelForm):
    class Meta:
        ...
        # Muallif, created_at, is_approved, views, is_recommended avtomatik yoki view'da belgilanadi
    ...
    # Agar adminlar uchun `is_approved` va `is_recommended` maydonlarini formaga qo'shmoqchi bo'lsangiz:
    ...
    #         self.Meta.fields.extend(['is_approved', 'is_recommended'])